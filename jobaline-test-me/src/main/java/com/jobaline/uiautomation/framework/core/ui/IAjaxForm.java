...
public interface IAjaxForm
{
	 ...
	 * */
	public abstract IAjaxForm fillForm(JSONObject data);
	 ...
	 * */
	public abstract void submitFormSuccessfullyAndWaitForResponse();
	 ...
	 *   - the browser gets a response from the server
	 * */
	public abstract void submitFormExpectingServerSideValidationErrorsAndWaitForResponse();
